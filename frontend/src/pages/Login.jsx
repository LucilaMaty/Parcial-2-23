...
const Login = () => {
  ...
  // 🔌 CONEXIÓN LIMPIA: Extraemos la función real del contexto
  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      if (esRegistro) {
        ...
        // Ejecutamos la función del contexto para guardar el estado en toda la app
        loginGlobal(datos.user || datos.usuario || datos, datos.token);
        
        // Redirección por roles exigida por el parcial
